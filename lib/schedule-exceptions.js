...
//  - "ok"     → slot servibile
function classifyScheduledSlot(scheduledDeliveryAt, now, storeWindows, exceptions) {
  ...
  const { date, shift } = orderShift(new Date(scheduledDeliveryAt).toISOString(), windowsByDow);
