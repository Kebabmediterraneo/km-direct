...
// La promozione. Il codice è quello scritto in `orders.coupon_code` e in
// `promo_redemptions.promo_code`: è un dato che finisce in tabella, non
// un'etichetta a schermo.
const GIVEMEFIVE_CODE = "GIVEMEFIVE";
const GIVEMEFIVE_THRESHOLD = 25;
const GIVEMEFIVE_DISCOUNT = 5;

// ⚠️ Il sito ha una SUA copia di soglia e importo (app/page.js), e nessuna
// prova confronta le due. Non è stato unificato in questo giro di proposito:
// vedi il referto dell'08/08/2026. Finché restano due, cambiarne una sola fa
