...
// §57-61 / §41-45 — IL TELEFONO SI PASSA COM'È.
//
// ⚠️⚠️ **QUI STAVA UN `+39` MESSO A INDOVINARE, ED È STATO TOLTO L'11/08/2026.**
// La riga diceva: se il numero non comincia per `+`, davanti va `+39`. Era
// nata quando il telefono non era controllato da nessuno e arrivava qui in
// qualunque forma — al punto che `"ciao"` usciva verso il rider come
// `"+39ciao"`.
//
// **Oggi il prefisso lo sceglie il cliente dalla tendina** (decisione P) e il
// numero arriva fin qui **già completo**, salvato in una forma sola per tutti
// (decisione R). Quella riga non ha più niente da indovinare — e se restasse,
// **indovinerebbe male**: un cliente che ha dichiarato la Francia si
// prenderebbe un `+39` davanti al suo numero, e il rider chiamerebbe un numero
// italiano che non esiste. *Una difesa costruita per un buco che è stato
// chiuso altrove non diventa inutile: diventa una seconda regola che può
// contraddire la prima.*
//
// ⚠️ **Ciò che questo cambio NON copre**: gli ordini già in database da prima,
// col numero salvato senza prefisso, escono ora senza `+39`. Sono ordini di
// prova — in database non ci sono clienti reali e verrà svuotato prima
// dell'apertura — ma se se ne ricaricasse uno vecchio su Glovo, il numero
// sarebbe incompleto.
