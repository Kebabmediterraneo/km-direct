...
export function validateCheckoutRequest(body, { referenceDate } = {}) {
  ...
  //
  // ⚠️ Il paese non viaggia ancora nella richiesta: finché la tendina dei
  // prefissi non esiste, vale il valore predefinito del modulo. Il giorno che
  // arriverà, si passa `body.customer.country` qui e **il modulo non si
  // riapre**.
  ...
  // mano.*
  if (checkPhone(customer.phone).outcome !== PHONE_OK) {
