...
// §67: le tre voci del selettore dietetico → i due flag. Definite in
// `menu-dietary.js` e importate qui: dal 06/08/2026 le usa anche la creazione
// (`menu-create.js`), e una seconda copia sarebbe divergibile. La regola non
// cambia di una virgola — "Vegano" implica sempre "Vegetariano", quindi lo
// stato incoerente resta impossibile per costruzione (§67, e caso g dei test).
